 ...
 * @EnableWebMvc
 * 
 * @ComponentScan(basePackages = "devframework.*") public class
 * MapeamentoConfiguration extends WebMvcConfigurerAdapter{
 * 
 * @Override public void addResourceHandlers(ResourceHandlerRegistry registry) {
 * 
 * if (!registry.hasMappingForPattern("/webjars/**")) {
 * registry.addResourceHandler("/webjars/**").addResourceLocations(
 * "classpath:/META-INF/resources/webjars/"); } registry.setOrder(1); }
 * 
 * }
 */