...
public interface IJsonRequestHandler extends IRequestHandler
{
	 ...
	 */
	public default void handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		// executa a logica da funcionalidade requisitada e obtem o objeto JSON de resposta
	...
	/**
	 * Operacao nao suportada por handlers assincronos!
	 * Lanca uma excecao UnsupportedOperationException caso este metodo seja invocado.
	 */
	public default void callPage(String page, HttpServletRequest request, HttpServletResponse response) throws UnsupportedOperationException
	{
	 ...
	 * Deve retornar um objeto JSON para ser enviado para a pagina solicitante processa-lo assincronamente.
	 */
